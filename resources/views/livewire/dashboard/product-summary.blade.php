                ...
                <table class="w-full">
                    <thead class="sticky top-0 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-zinc-700 dark:text-gray-400">
                        <tr>
                            <th class="px-4 py-3 text-left">Product</th>
                            <th class="px-4 py-3 text-right">Stock</th>
                            <th class="px-4 py-3 text-right">2x Threshold</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-zinc-700">
                            ...
                            <td class="px-4 py-3 text-right text-purple-600 dark:text-purple-400 font-medium">{{ $product->quantity_in_stock }}</td>
                            <td class="px-4 py-3 text-right text-gray-600 dark:text-gray-400">{{ $product->reorder_threshold * 2 }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="3" class="px-4 py-4 text-center text-gray-500 dark:text-gray-400">
