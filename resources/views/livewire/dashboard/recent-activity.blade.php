<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden dark:bg-gray-800">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="w-full sm:w-48">
                    ...
                    <select
                        ...
                        class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-md transition-colors duration-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    >
                ...
                @else
                    <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($this->recentTransactions as $transaction)
                            <li class="py-4 hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors duration-150 px-2 -mx-2 rounded">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="min-w-0 flex-1">
                                        <div class="flex items-center gap-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $transaction->type->color() }}">
                                        ...
                                        <div class="mt-2 flex items-center text-sm text-gray-500 dark:text-gray-400">
                                            @if($transaction->user)
                                                <svg class="flex-shrink-0 mr-1.5 h-4 w-4 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div class="flex flex-col items-end">
                                        ...
                                        <div class="flex items-center mt-1 text-sm text-gray-500 dark:text-gray-400">
                                            <svg class="flex-shrink-0 mr-1 h-4 w-4 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="px-6 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 text-right">
            <a href="{{route('transactions')}}" class="text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
